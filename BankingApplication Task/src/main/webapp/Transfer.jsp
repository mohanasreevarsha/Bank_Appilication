...
<fieldset>
<table>
<h1 style="color:parrotgreen">TRANSFER FORM</h1>
...
<tr><td>Traget Account No:<td>
<td><input type="number" name="tamun"></td></tr>
